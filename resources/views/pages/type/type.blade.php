        ...
        <div class="container">
            <div class="item__content">
                ...
                <div class="item__content-list">
                    @if ($products->isEmpty())
                        <div><span style='font-weight:bold;color:rgb(224, 24, 24)'> Hiện tại không có sản phẩm nào thuộc loại này</span></div>
                    @else
                        @foreach ($products as $item)
                            <div class='detail'>
                                <a href='{{URL::to("/productDetail/$item->id_product")}}' alt=''>
                                <img src= '{{URL::asset("img/$item->product_img")}}' />
                                <a href='{{URL::to("/productDetail/$item->id_product")}}' class='productDetail'>Chi tiết</a>
